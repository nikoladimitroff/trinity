...
static double RPNParse(double x, double y, double z, queue<string> surfaceEquation) //TODO:NIKOLA tuka malko ne moa si spomnq kak si bqhme napravili Vector v trinity
{
	stack<double> values;
...
int main()
{
	string input = "x * min(10,50) / (2 * max(1,2))";
	queue<string> surfceEquation = ShuntingYard(tokenize(input));
	cout<<RPNParse(10,0,0,surfceEquation);
}
